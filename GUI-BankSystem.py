...
def Cr_Amt(accnt,name):
	...
	creditwn.configure(bg="green")
	fr1=tk.Frame(creditwn,bg="red")
	l_title=tk.Message(creditwn,text="BANK ACCOUNT BOOK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	fr1=tk.Frame(debitwn,bg="green")
	l_title=tk.Message(debitwn,text="BANK ACCOUNT BOOK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="BANK ACCOUNT BOOK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("BANK ACCOUNT BOOK-"+name)
	rootwn.configure(background='green')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="BANK ACCOUNT\n BOOK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	fr1=tk.Frame(loginwn,bg="red")
	l_title=tk.Message(loginwn,text="BANK ACCOUNT BOOK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	l_title=tk.Message(crwn,text="BANK ACCOUNT BOOK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	rootwn=tk.Tk()
	rootwn.geometry("1600x500")
	rootwn.title("BANK ACCOUNT BOOK")
	...
	x.place(y=-400)
	l_title=tk.Message(text="BANK ACCOUNT\n BOOK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
